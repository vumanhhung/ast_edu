import { Directive, ElementRef, EventEmitter, HostBinding, HostListener, Input, Renderer2 as Renderer, Output, Optional } from '@angular/core';
...
export class ButtonDirective {
    constructor(element, renderer, service, localization) {

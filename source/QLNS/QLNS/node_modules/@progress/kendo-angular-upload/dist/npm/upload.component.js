...
var UploadComponent = /** @class */ (function () {
    function UploadComponent(uploadService, localization, navigation, _ngZone, renderer, wrapper) {
         ...
         * @hidden
         */
        this.focusableId = "k-" + util_1.default.guid();
        /**
    ...
    UploadComponent.prototype.handleKeydown = function (event) {
        ...
        if ((event.keyCode === navigation_service_1.Keys.enter || event.keyCode === navigation_service_1.Keys.space) &&
    ...
    UploadComponent.prototype.writeValue = function (newValue) {
        ...
        if (newValue instanceof Array) {
            newValue.forEach(function (file) {
                if (!util_1.default.validateInitialFileInfo(file)) {
                    isValid = false;
                }
            });
            if (isValid) {
    ...
    UploadComponent.prototype.subscribeBlur = function () {
        ...
        this._ngZone.runOutsideAngular(function () {
            ...
            _this.blurSubscription = merge_1.merge(_this.documentClick, _this.navigation.onTab).subscribe(function () { return _this._ngZone.run(function () {

...
var NavigationModel = /** @class */ (function () {
    ...
    NavigationModel.prototype.registerItem = function (index, disabled) {
        var children = [];
        ...
        if (parent || level === 1) {
            ...
            var node = { children: children, index: index, parent: parent, prev: prev, next: next, disabled: disabled };
            link(node);

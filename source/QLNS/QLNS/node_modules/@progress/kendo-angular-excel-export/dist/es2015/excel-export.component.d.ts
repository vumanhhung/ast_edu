...
export declare class ExcelExportComponent {
    ...
    /**
     * The exported data.
     * If grouped, the data must have the structure described by the [`GroupResult`]({% slug api_kendo-data-query_groupresult %}) option of the Kendo UI DataQuery.
     */
    data: any[];
    /**
     * The exported data groups.
     * The groups must be compatible with the [`GroupDescriptor`]({% slug api_kendo-data-query_groupdescriptor %}) option of the Kendo UI DataQuery.
     */
    group: any[];
    /**

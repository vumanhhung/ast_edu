...
var NavigationService = /** @class */ (function () {
    ...
    NavigationService.prototype.init = function (meta) {
        ...
        var onStableSubscriber = function () {
            ...
            return function () {
                return _this.zone.isStable ?
                    from([true]) : (_a = _this.zone.onStable).pipe.apply(_a, [take(1)].concat(operators));
                var _a;
            };
        };
        ...
        this.subs.add(this.domEvents.focusOut.pipe(filter(function () { return _this.mode !== 0 /* Standby */; }), switchMap(onStableSubscriber(takeUntil(this.domEvents.focus)), function (args) { return args; }))

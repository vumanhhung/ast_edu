...
export class NavigationService {
    ...
    init(meta) {
        ...
        const onStableSubscriber = (...operators) => () => this.zone.isStable ?
            from([true]) :
            this.zone.onStable.pipe(take(1), ...operators);
        ...
        this.subs.add(this.domEvents.focusOut.pipe(filter(() => this.mode !== 0 /* Standby */), switchMap(onStableSubscriber(takeUntil(this.domEvents.focus)), args => args))

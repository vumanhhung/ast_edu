...
var NavigationModel = /** @class */ (function () {
    ...
    NavigationModel.prototype.unregisterRow = function (logicalRowIndex) {
        var entry = findByIndex(this.rows, logicalRowIndex);
        if (entry) {
            var index = this.rows.indexOf(entry);
...
var LogicalCellDirective = /** @class */ (function () {
    ...
    LogicalCellDirective.prototype.onStable = function (callback) {
        var stable = this.zone.isStable ?
            from$1([true]) : this.zone.onStable.pipe(take$1(1));
        stable.subscribe(function () { return callback(); });
    };
    LogicalCellDirective.prototype.updateElement = function () {
        ...
        if (this.isFocused()) {
            if (this.focusGroup.isNavigable()) {
                ...
                this.onStable(function () { return _this.isFocused() && el.focus(); });
...
var LogicalRowDirective = /** @class */ (function () {
    ...
    LogicalRowDirective.prototype.ngOnChanges = function (changes) {
        ...
        if (indexChange && !indexChange.isFirstChange()) {
            // Existing row moved to a new index: unregister from the old position
            this.navigation.unregisterRow(indexChange.previousValue);
        }
        if (!indexChange) {
            // Other changes: unregister from current position
            this.navigation.unregisterRow(this.logicalRowIndex);
        }
...
export { ColumnChooserComponent as ɵdd, ColumnListComponent as ɵdc, ColumnMenuChooserComponent as ɵde, ColumnMenuFilterComponent as ɵdg, ColumnMenuItemBase as ɵdf, ColumnMenuItemContentTemplateDirective as ɵdi, ColumnMenuItemComponent as ɵdh, ColumnMenuLockComponent as ɵdm, ColumnMenuSortComponent as ɵdj, ColumnMenuTemplateDirective as ɵbe, ColumnMenuComponent as ɵdk, ColumnMenuModule as ɵdb, ColumnMenuService as ɵdl, ColumnHandleDirective as ɵce, ColumnResizingService as ɵu, TableDirective as ɵbu, ColumnInfoService as ɵe, DomEventsService as ɵf, DraggableDirective as ɵbp, ExpandStateService as ɵi, IdService as ɵbc, PreventableEvent as ɵdo, SortService as ɵbd, ChangeNotificationService as ɵl, ColumnReorderService as ɵy, DragAndDropModule as ɵbv, DragAndDropService as ɵv, DragHintService as ɵw, DraggableColumnDirective as ɵbw, DropCueService as ɵx, DropTargetDirective as ɵbn, EditingDirectiveBase as ɵbk, RowEditingDirectiveBase as ɵbj, AddCommandDirective as ɵcd, CancelCommandDirective as ɵca, EditCommandDirective as ɵbz, EditService as ɵm, LocalDataChangesService as ɵg, RemoveCommandDirective as ɵcc, SaveCommandDirective as ɵcb, ExcelCommandDirective as ɵdr, BooleanFilterComponent as ɵcl, BooleanFilterCellComponent as ɵck, FilterCellHostDirective as ɵcm, FilterCellOperatorsComponent as ɵct, FilterCellWrapperComponent as ɵco, DateFilterComponent as ɵcr, FilterHostDirective as ɵcn, FilterInputWrapperComponent as ɵcp, FilterInputDirective as ɵcq, FilterRowComponent as ɵcg, DateFilterMenuInputComponent as ɵcz, FilterMenuContainerComponent as ɵcv, FilterMenuHostDirective as ɵda, FilterMenuInputWrapperComponent as ɵcw, FilterMenuComponent as ɵcu, NumericFilterMenuInputComponent as ɵcy, StringFilterMenuInputComponent as ɵcx, NumericFilterComponent as ɵcj, FilterOperatorBase as ɵci, SharedFilterModule as ɵcs, StringFilterComponent as ɵch, GroupHeaderComponent as ɵbl, GroupIndicatorComponent as ɵbo, GroupInfoService as ɵk, GroupPanelComponent as ɵbm, GroupsService as ɵj, BrowserSupportService as ɵd, ResizeService as ɵt, ResponsiveService as ɵq, LocalizedMessagesDirective as ɵbg, Messages as ɵbh, FocusGroup as ɵbr, FocusRoot as ɵbb, LogicalCellDirective as ɵbq, LogicalRowDirective as ɵbs, NavigationService as ɵz, PagerContextService as ɵr, PagerElementComponent as ɵdn, PDFCommandDirective as ɵdq, PDFTemplateDirective$1 as ɵdp, CellComponent as ɵby, CELL_CONTEXT as ɵn, EMPTY_CELL_CONTEXT as ɵp, FieldAccessorPipe as ɵbt, DetailsService as ɵh, DEFAULT_SCROLLER_FACTORY as ɵc, SCROLLER_FACTORY_TOKEN as ɵb, ScrollRequestService as ɵba, ScrollSyncService as ɵs, ScrollerService as ɵbf, SelectAllCheckboxDirective as ɵcf, SelectionCheckboxDirective as ɵbx, Selection as ɵbi, SelectionService as ɵa, GridModule, SharedModule, GridComponent, ColumnBase$1 as ColumnBase, ColumnComponent, CommandColumnComponent, SpanColumnComponent, ColumnGroupComponent, CheckboxColumnComponent, ToolbarComponent, ToolbarTemplateDirective, CellTemplateDirective, HeaderTemplateDirective, FooterTemplateDirective, PagerTemplateDirective, DetailTemplateDirective, DetailExpandEvent, DetailCollapseEvent, GroupHeaderTemplateDirective, GroupFooterTemplateDirective, ResizableContainerDirective, TemplateContextDirective, NoRecordsTemplateDirective, DataBindingDirective, SelectionDirective, FilterService, FilterCellTemplateDirective, FilterCellComponent, StringFilterCellComponent, DateFilterCellComponent, BaseFilterCellComponent, FilterMenuTemplateDirective, NumericFilterMenuComponent, StringFilterMenuComponent, DateFilterMenuComponent, BooleanFilterMenuComponent, BeforeEqFilterOperatorComponent, BeforeFilterOperatorComponent, AfterEqFilterOperatorComponent, AfterFilterOperatorComponent, ContainsFilterOperatorComponent, DoesNotContainFilterOperatorComponent, EndsWithFilterOperatorComponent, EqualFilterOperatorComponent, IsEmptyFilterOperatorComponent, IsNotEmptyFilterOperatorComponent, IsNotNullFilterOperatorComponent, IsNullFilterOperatorComponent, NotEqualFilterOperatorComponent, StartsWithFilterOperatorComponent, NumericFilterCellComponent, AutoCompleteFilterCellComponent, GreaterFilterOperatorComponent, GreaterOrEqualToFilterOperatorComponent, LessOrEqualToFilterOperatorComponent, LessFilterOperatorComponent, PagerPrevButtonsComponent, PagerNextButtonsComponent, PagerNumericButtonsComponent, PagerInputComponent, PagerInfoComponent, PagerPageSizesComponent, RowFilterModule, FilterMenuModule, BodyModule, GroupModule, HeaderModule, FooterModule, PagerModule, TemplateEditingDirective, ReactiveEditingDirective, InCellEditingDirective, EditTemplateDirective, ColGroupComponent, HeaderComponent, ListComponent, FooterComponent, TableBodyComponent, PagerComponent, CustomMessagesComponent, LoadingComponent, PDFModule, PDFComponent, PDFMarginComponent$1 as PDFMarginComponent, PDFService, ExcelModule, ExcelComponent, ExcelService, SuspendService, GroupBindingDirective, slice, count, Skip, ColumnReorderEvent, FocusableDirective, ColumnVisibilityChangeEvent, SinglePopupService, PopupCloseEvent };

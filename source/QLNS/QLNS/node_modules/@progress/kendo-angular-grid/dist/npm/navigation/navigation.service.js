...
var NavigationService = /** @class */ (function () {
    ...
    NavigationService.prototype.init = function (meta) {
        ...
        var onStableSubscriber = function () {
            ...
            return function () {
                return _this.zone.isStable ?
                    from_1.from([true]) : (_a = _this.zone.onStable).pipe.apply(_a, [take_1.take(1)].concat(operators));
                var _a;
            };
        };
        ...
        this.subs.add(this.domEvents.focusOut.pipe(filter_1.filter(function () { return _this.mode !== 0 /* Standby */; }), switchMap_1.switchMap(onStableSubscriber(takeUntil_1.takeUntil(this.domEvents.focus)), function (args) { return args; }))

...
var ListComponent = /** @class */ (function () {
    ...
    ListComponent.prototype.createScroller = function () {
        ...
        this.scrollerSubscription.add(observable.pipe(filter_1.filter(function (x) { return x instanceof scroller_service_1.ScrollAction; }))
            .subscribe(this.scroll.bind(this)));
        this.scrollerSubscription.add(observable.pipe(filter_1.filter(function (x) { return x instanceof scroller_service_1.ScrollBottomAction; }))

...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.attachTargets = function () {
        ...
        var enterStream = merge_1.merge.apply(void 0, this.dropTargets.map(function (target) { return target.enter; }));
        var leaveStream = merge_1.merge.apply(void 0, this.dropTargets.map(function (target) { return target.leave; }));
        var dropStream = merge_1.merge.apply(void 0, this.dropTargets.map(function (target) { return target.drop; }));
    ...
    HeaderComponent.prototype.trackMove = function (leaveStream, dropStream, e) {
        ...
        return of_1.of(mergeObjects({ changeContainer: changed }, e));
    };

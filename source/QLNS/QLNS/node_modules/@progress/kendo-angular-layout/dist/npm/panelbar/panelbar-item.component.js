        ...
        { type: core_1.Component, args: [{
                    animations: [
                        animations_1.trigger('toggle', [
                            animations_1.state('inactive', animations_1.style({ display: 'none', height: '0px' })),
                            animations_1.transition('active => void', [
                                animations_1.animate(200, animations_1.style({ display: 'block', height: '0px' }))
                            ]),
                            animations_1.transition('void => active', [
                                animations_1.style({ display: 'block', height: '0px' }),
                                animations_1.animate(200, animations_1.style({ display: 'block', height: animations_1.AUTO_STYLE }))
                            ]),
                            ...
                            animations_1.transition('active => inactive', [
                                animations_1.animate(200, animations_1.style({ display: 'none', height: '0px' }))
                            ])
                        ])
                    ],

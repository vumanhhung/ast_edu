...
export class Utilities {
    ...
    public static printDateOnly(date: Date) {
        ...
        let dayNames = new Array("Chủ nhật", "Thứ hai", "Thứ ba", "Thứ tư", "Thứ năm", "Thứ sáu", "Thứ bảy");
        let monthNames = new Array("Tháng 1", "Tháng 2", "Tháng 3", "Tháng 4", "Tháng 5", "Tháng 6", "Tháng 7", "Tháng 8", "Tháng 9", "Tháng 10", "Tháng 11", "Tháng 12");
    ...
    public static LayMangChuoi(chuoiNguon: string, chuoiPhanCach: string): string[] {
        if (chuoiPhanCach.length < 1) {
            chuoiPhanCach = "*!<=*ParamsSpilitItems*=>*!";
        }
        var strArray: string[] = chuoiNguon.split(chuoiPhanCach);
        return strArray;
    }
